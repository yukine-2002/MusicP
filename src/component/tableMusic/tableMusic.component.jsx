  ...
  return (
    <div>
      <div className="media" >
        ...
        ></audio>
        <div className="media-left" onClick={()=> {addMusic(songs) ;console.log(songs)} }>
        ...
        <div className="media-right">
          <div className="love" onClick={() => {addListLoves(songs)}}>
...
const mapDispatchToProps = dispatch => ({
  ...
  addListLoves:(item) => dispatch(addListLoves(item))
})

export default connect(null,mapDispatchToProps)(TableMusic);
